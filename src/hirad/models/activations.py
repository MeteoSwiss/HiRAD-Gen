...
class Identity(nn.Module):
    ...
    Example
    -------
    >>> idnt_func = hirad.models.activations.Identity()
...
class Stan(nn.Module):
    ...
    Example
    -------
    >>> stan_func = hirad.models.activations.Stan(out_features=1)
...
class SquarePlus(nn.Module):
    ...
    Example
    -------
    >>> sqr_func = hirad.models.activations.SquarePlus()
...
class CappedLeakyReLU(torch.nn.Module):
    ...
    Example
    -------
    >>> capped_leakyReLU_func = hirad.models.activations.CappedLeakyReLU()
...
class CappedGELU(torch.nn.Module):
    ...
    Example
    -------
    >>> capped_gelu_func = hirad.models.activations.CappedGELU()
    >>> input = torch.Tensor([[-2,-1],[0,1],[2,3]])
