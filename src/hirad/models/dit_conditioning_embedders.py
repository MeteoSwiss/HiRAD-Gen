...
class ZeroConditioningEmbedder(nn.Module):
...
class DiTConditionEmbedder(nn.Module):
...
class EDMConditionEmbedder(nn.Module):
...
class ConditioningEmbedderType(Enum):
    ...
    Used by :func:`~hirad.models.dit_conditioning_embedders.get_conditioning_embedder`
...
def get_conditioning_embedder(
    ...
    **kwargs
        ...
        See :class:`~hirad.models.dit_conditioning_embedders.DiTConditionEmbedder` or
        :class:`~hirad.models.dit_conditioning_embedders.EDMConditionEmbedder` for available options.

    Returns
    -------
    ConditioningEmbedder
        An instance implementing the :class:`~hirad.models.dit_conditioning_embedders.ConditioningEmbedder` protocol.
    """
