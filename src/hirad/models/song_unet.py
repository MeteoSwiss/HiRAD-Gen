...
from .utils import _recursive_property, get_group_norm
...
class SongUNetPosEmbd(SongUNet):
    ...
    :class:`~hirad.models.SongUNet` with positional
    ...
    :class:`~hirad.models.SongUNet`. Only the ones
    ...
    in_channels : int
        ...
        **Important:** in comparison to the base
        :class:`~hirad.models.SongUNet`, this
    ...
    lead_time_channels : int, optional, default=None
        Provided for convenience. Refer to :class:`~hirad.models.SongUNetPosLtEmbd`.
    ...
    . important::
        ...
        class :class:`~hirad.models.SongUNet` that
    ...
    --------
    >>> import torch
    >>> from hirad.models. import SongUNetPosEmbd
        ...
        *patches*). If no indices are provided, the entire embedding grid is returned.
        ...
        -----
            - This method is typically used in patch-based diffusion (or
              ...
              to each patch.
            - See this method from :class:`hirad.utils.patching.BasePatching2D`
              for generating the ``global_index`` parameter:
              :meth:`~hirad.utils.patching.BasePatching2D.global_index`.
        """
    ...
    def positional_embedding_selector(
        ...
        -----
            - This method is typically used in patch-based diffusion (or
              ...
              patch.
            - See the method
              :meth:`~hirad.utils.patching.BasePatching2D.apply` from
              :class:`hirad.utils.patching.BasePatching2D` for generating
...
class SongUNetPosLtEmbd(SongUNetPosEmbd):
    ...
    :class:`~hirad.models.SongUNetPosEmbd` with two
    ...
    :class:`~hirad.models.SongUNetPosEmbd`, at the
    ...
    in_channels : int
        ...
        *Important:* in comparison to the base :class:`~hirad.models.SongUNet`,
    ...
    -----
        - The lead-time embeddings differ from the diffusion time embeddings used in
          :class:`~hirad.models.SongUNet` class, as they do not
          encode diffusion time-step but *physical forecast time*.

    Example
    --------
    >>> import torch
    >>> from hirad.models. import SongUNetPosLtEmbd
    >>> from hirad.utils.patching import GridPatching2D
    >>>
