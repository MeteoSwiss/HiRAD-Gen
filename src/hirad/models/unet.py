...
class UNet(nn.Module):  # TODO a lot of redundancy, need to clean up
    ...
    - :class:`~hirad.models.song_unet.SongUNet`

    - :class:`~hirad.models.song_unet.SongUNetPosEmbd`

    - :class:`~hirad.models.song_unet.SongUNetPosLtEmbd`

    - :class:`~hirad.models.dhariwal_unet.DhariwalUNet`
