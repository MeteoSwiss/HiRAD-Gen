...
#SBATCH --job-name="ifso1280-real-regression"
...
### OUTPUT ###
#SBATCH --output=./logs/train_ifso1280_real_regression.log
#SBATCH --error=./logs/train_ifso1280_real_regression.err
...
srun --mpi=pmix --network=disable_rdzv_get --environment=./ci/edf/modulus_env.toml bash -c "
    ...
    python src/hirad/training/train.py --config-name=training_ifso1280_real_regression.yaml
"
